...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue function in the PersonQueue class was inserting at the 
    // front of the the list instead of the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson was skipping people with infinite turns (0 or less)
